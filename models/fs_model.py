...
class fsModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        netArc_path = opt.Arc_path  # get the path from CLI options
        torch.serialization.add_safe_globals([ResNet])  # allow loading ResNet safely
        netArc_checkpoint = torch.load(netArc_path, map_location=device, weights_only=False)
